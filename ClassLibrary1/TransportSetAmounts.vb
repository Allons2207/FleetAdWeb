...
Public Class TransportSetAmounts
    ...
    Public Sub Update(ByVal ctr As String, ByVal mmonth As String, ByVal amount As String, ByVal yYear As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Update_tbl_transportSetAmounts", conn)
    ...
    Public Sub Insert()
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Insert_tbl_transportSetAmounts", conn)
        cmd.CommandType = CommandType.StoredProcedure
        'cmd.Parameters.AddWithValue("@ctr", ctr)
        cmd.Parameters.AddWithValue("@mmonth", mmonth)
        cmd.Parameters.AddWithValue("@amount", amount)
    ...
    Public Sub Delete(ByVal ID As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Delete_tbl_transportSetAmounts", conn)
        cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function SelectRecords() As DataSet
        ...
        Dim sql As String = "select * from [dbo].[tbl_transportSetAmounts]"
