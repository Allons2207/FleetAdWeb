...
Public Class UserGroups
    ...
    Public Sub Update(ByVal userGroupId As String, ByVal userGroup As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Update_tbl_userGroups", conn)
    ...
    Public Sub Insert(ByVal userGroupId As String, ByVal userGroup As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Insert_tbl_userGroups", conn)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@userGroupId", userGroupId)
        cmd.Parameters.AddWithValue("@userGroup", userGroup)
    ...
    Public Sub Delete(ByVal ID As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Delete_tbl_userGroups", conn)
        cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function SelectRecords() As DataSet
        Dim sql As String = "select * from tbl_userGroups"
