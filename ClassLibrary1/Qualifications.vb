...
Public Class Qualifications
    ...
    Public Sub Update(ByVal qualificationId As String, ByVal qualification As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Update_tbl_qualifications", conn)
    ...
    Public Sub Insert(ByVal qualificationId As String, ByVal qualification As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Insert_tbl_qualifications", conn)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@qualificationId", qualificationId)
        cmd.Parameters.AddWithValue("@qualification", qualification)
    ...
    Public Sub Delete(ByVal ID As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Delete_tbl_qualifications", conn)
        cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function SelectRecords() As DataSet
        ...
        Dim sql As String = "select * from [dbo].[tbl_qualifications]"
