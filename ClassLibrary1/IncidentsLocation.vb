...
Public Class IncidentsLocation
    ...
    Public Sub Update(ByVal locationID As String, ByVal location As String)
        ...
        Dim cmd As New SqlCommand("Update_tblIncidentsLocation", conn)
    ...
    Public Sub Insert(ByVal locationID As String, ByVal location As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Insert_tblIncidentsLocation", conn)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@locationID", locationID)
        cmd.Parameters.AddWithValue("@location", location)
    ...
    Public Sub Delete(ByVal ID As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Delete_tblIncidentsLocation", conn)
        cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function SelectRecords() As DataSet
        ...
        Dim sql As String = "select * from [dbo].[tblIncidentsLocation]"
