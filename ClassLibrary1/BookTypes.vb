...
Public Class BookTypes
    ...
    Public Sub Update(ByVal bookTypeId As String, ByVal bookType As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Update_tbl_bookTypes", conn)
    ...
    Public Sub Insert(ByVal bookTypeId As String, ByVal bookType As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Insert_tbl_bookTypes", conn)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@bookTypeId", bookTypeId)
        cmd.Parameters.AddWithValue("@bookType", bookType)
    ...
    Public Sub Delete(ByVal ID As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Delete_tbl_bookTypes", conn)
        cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function SelectRecords() As DataSet
        Dim sql As String = "  SELECT * FROM tbl_bookTypes"
        Try
