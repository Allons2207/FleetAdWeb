...
Public Class Assets
    ...
    Public Sub Update(ByVal assetTypeId As String, ByVal assetId As String, ByVal asset As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Update_tbl_assets", conn)
    ...
    Public Sub Insert(ByVal assetTypeId As String, ByVal assetId As String, ByVal asset As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Insert_tbl_assets", conn)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@assetTypeId", assetTypeId)
        cmd.Parameters.AddWithValue("@assetId", assetId)
        cmd.Parameters.AddWithValue("@asset", asset)
    ...
    Public Sub Delete(ByVal ID As String)
        Dim conn As New SqlConnection(ConnectionString)
        Dim cmd As New SqlCommand("Delete_tbl_assets", conn)
        cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function SelectRecords() As DataSet
        Dim sql As String = "  SELECT * FROM tbl_assets"
        Try
