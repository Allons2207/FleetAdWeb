<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PremaintainanceDetails.aspx.vb" Inherits="WebApplication2.PremaintainanceDetails" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Pre-Maintance Inspection Details</h6>
                </nav>
                  ...
                  <div class="card">
                    <div class="card-header pt-0 p-3  text-center">
                      <div class="row">
                        <div class="col-6">
                           ...
                           <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                            <label for="DropDownList1" class="ms-0">Work Order</label>
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                        ...
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="dfa" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfb" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                    </div>
                           <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfc" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfd" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                               </div>
                                  <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfe" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dff" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                                       </div>
                                         <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfg" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfh" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                                              </div>
                                                <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfi" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfj" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                                                     </div>
                                                       <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfk" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfl" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                                                       </div>
                          <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfm" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfn" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                                                                </div>
                            <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfo" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfp" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                                                                          </div>
             <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfq" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfr" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                                                                                 </div>
                                                                                   <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dfs" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Defect</label>
                            <asp:TextBox ID="dft" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                         </div>
                                                                                          <div class="row">
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtInsp" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label"></label>
                            <asp:TextBox ID="TextBox25" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode ="Date" ></asp:TextBox>
                            </div>
                        </div>
                                                                                               </div>
               ...
               <div class ="row mt-4">
                   ...
                   <div class="col-lg-4">
                       <div class ="col-12">
                           <asp:Button ID="Button1" runat="server" Text="Save" class="btn btn-lg btn-success w-100"  OnClick="Save"/>
