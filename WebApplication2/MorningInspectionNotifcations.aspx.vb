...
Public Class MorningInspectionNotifcations
    ...
    Private Sub loadData()
        Dim sql As String = "SELECT        FLEETID, DATE, WHEELS, LIGHTS, COOLANT, BOLT, SUSPENSION, INSPBY, DATEDIFF(day, DATE, GETDATE()) AS DAT
