<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VehicleInformation.aspx.vb" Inherits="WebApplication2.VehicleInformation" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Vehicle Information</h6>
                </nav>
...
<span class="small">11</span>
        ...
        <div class="card card-body text-center" id="profile">
          <div class="row justify-content-center align-items-center">
            <div class="col-sm-auto col-4">
              <div class="avatar avatar-xl position-relative">
                <button
                class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 p-3 btn-lg d-flex align-items-center justify-content-center">
                <i class="material-icons me-2 text-lg">directions_car</i></button>               
              </div>
            </div>
            <div class="col-sm-auto col-8 my-auto text-center">
              <div class="h-100">
      ...
      <div class="row mt-4 mb-4">
              ...
              <div class="col-lg-12 mt-lg-0 mt-4">
                  ...
                  <div class="card-body pt-0">
                    <div class="row">
                      ...
                      <div class="col-6">
                        <div class="input-group input-group-static">
                          <label>FleetId</label>
                                                        <asp:TextBox ID="txtFleet" runat="server"  class="form-control"></asp:TextBox>
               ...
               <div class="row">
                      ...
                      <div class="col-6">
                        <div class="input-group input-group-static">
                          <label>Model</label>
                                                        <asp:TextBox ID="txtmod" runat="server"  class="form-control"></asp:TextBox>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-sm-0 mb-4">
                      ...
                      <div class="w-50 text-end">
                        <button class="btn btn-outline-success mb-3 mb-md-0 ms-auto" type="button"
                          name="button">Licence Details</button>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-lg-5 col-12 mt-md-0 mt-4">
          <div class="card h-100 mb-4">
            ...
            <div class="card-body pt-4 p-3">
              <h6 class="text-uppercase text-body text-xs font-weight-bolder mb-3">Zinara</h6>
              <ul class="list-group">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">
                         LICNUMBER :   <asp:Label ID="txtzin" runat="server" Text="Label"></asp:Label>
                      </h6>
                      <span class="text-xs">
                          EXPIRY : <asp:Label ID="txtzindate" runat="server" Text="Label"></asp:Label>
                      </span>
                    </div>
              ...
              <h6 class="text-uppercase text-body text-xs font-weight-bolder my-3">ZBC</h6>
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    <button
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">
                          LICNUMBER :  <asp:Label ID="txtzb" runat="server" Text="Label"></asp:Label>
                      </h6>
                      <span class="text-xs">
                          EXPIRY : <asp:Label ID="txtzbdate" runat="server" Text="Label"></asp:Label>
                      </span>
                    </div>
              ...
              <h6 class="text-uppercase text-body text-xs font-weight-bolder my-3">Insurance</h6>
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">
                        LICNUMBER :   <asp:Label ID="allgood" runat="server" Text="Label"></asp:Label>
                      </h6>
                      <span class="text-xs">
                          EXPIRY :<asp:Label ID="allgooddate" runat="server" Text="Label"></asp:Label>
                      </span>
                    </div>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            <a href="" class="font-weight-bold" target="_blank">Primasys</a> for a better web.
                        </div>
                    </div>
                    <div class="col-lg-6">
