<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QuarterlyInspection.aspx.vb" Inherits="WebApplication2.QuarterlyInspection" %>
...
<span class="small">11</span>
                ...
                <div class="col-sm-2 mt-2 text">
                    <div class="text-center">
                        <div class="col-md-6 text-center">
                            <asp:Button ID="Button1" runat="server"  class="btn b-lg-block bg-gradient-warning mb-3 modal-dialog-centered mt-3 text-bold "  Text="Add New" OnClick="Details" />
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Quaterly Inspection</h5>
                        <p class="text-sm mb-0">
                            Quaterly  Inspection List
                        </p>
                    </div>
        ...
        <Columns>
           ...
           <asp:BoundField DataField="TEC" HeaderText="Inspector" />
            <asp:BoundField DataField="NEXTDATE" HeaderText="Next Service" />
            <asp:BoundField DataField="MILE" HeaderText="MILE" />
