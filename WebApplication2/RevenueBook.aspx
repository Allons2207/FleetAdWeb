...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SchoolAppMaster.Master" CodeBehind="RevenueBook.aspx.vb" Inherits="WebApplication2.RevenueBook" %>
                ...
                <asp:Panel ID="Panel2" runat="server" Width="568px">
                    ...
                    <table><tr><td class="auto-style1">
                                ...
                                Item Type
                                 ...
                                 Expected</td><td class="auto-style1">Cash at Hand</td><td class="auto-style1">Cash Left</td>
                        <td class="auto-style1">Variance</td><td class="auto-style1">Receipted By</td><td class="auto-style1">Center</td></tr>
                        <tr><td>                   
                            ...
                            <asp:TextBox ID="txtCashLeft" runat="server"></asp:TextBox>
                            </td><td><asp:TextBox ID="txtVariance" runat="server"></asp:TextBox>
                            </td><td>
                            <asp:TextBox ID="txtReceiptedBy" runat="server"></asp:TextBox>
                            </td><td>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td class="auto-style1">Notes</td><td colspan ="3">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="cmdAddNew" runat="server" Text="Save Revenue Entry" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
