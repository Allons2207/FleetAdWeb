<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ScheduleList.aspx.vb" Inherits="WebApplication2.ScheduleList" %>
    ...
    <nav
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Schedule Bus Trips</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
              ...
              <div class="row">
                <div class="col-md-6 col-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Buses</h6>
                      <span class="text-xs">Trip</span>
                      <hr class="horizontal dark my-3">
                        <asp:Label ID="Labelss" runat="server" class="mb-0 h5 " Text="Label"></asp:Label>
                ...
                <div class="col-md-6 col-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Buses on Trips</h6>
                                ...
                                <div class="card-header pb-0 p-3 mb-4">
                                    <div class="row">
                                        <div class="col-6 d-flex align-items-center">
                                            <asp:Button ID="Button1" runat="server"  class="btn bg-gradient-dark mb-0" Text="Add New" OnClick="garag" />
                                       
                                        </div>
                                        <div class="col-6 text-end">
                                           <asp:Button ID="Button2" runat="server"  class="btn bg-gradient-dark mb-0" Text="View Calendar Schedule" OnClick="bus" />
                                        </div>
                                    </div>
                                </div>
      ...
      <div class="row my-4">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="SCESTATUS" HeaderText="Duty" />
            <asp:BoundField DataField="SCESTAT" HeaderText="Time" />
            <asp:BoundField DataField="RUTE" HeaderText="To" />
            <asp:BoundField DataField="DESCR" HeaderText="From" />
