...
Public Class CertificatesOfFitness
    ...
    Private Sub loadExistingLicenseDetails()
        Dim qry As String = "SELECT dbo.tbl_CertificatesOfFitnessLicensing.fleetId, dbo.tbl_CertificatesOfFitnessLicensing.licenseNum, dbo.tbl_CertificatesOfFitnessLicensing.dateIssued," &
                            " dbo.tbl_CertificatesOfFitnessLicensing.expiryDate, dbo.tbl_CertificatesOfFitnessLicensing.commentsNotes, dbo.tbl_vehicleMakes.vehicleMake, " &
                            " dbo.tbl_vehicleModels.vehicleModel, dbo.tbl_vehicleData.registrationNumber AS RegNumber FROM   dbo.tbl_CertificatesOfFitnessLicensing INNER JOIN dbo.tbl_vehicleModels INNER JOIN " &
                            ...
                            " dbo.tbl_CertificatesOfFitnessLicensing.fleetId = dbo.tbl_vehicleData.fleetId WHERE " &
                            " (dbo.tbl_CertificatesOfFitnessLicensing.fleetId = '" & (Request.QueryString("op")) & "')"
    ...
    Protected Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        Dim qry As String = "DELETE FROM  tbl_CertificatesOfFitnessLicensing WHERE fleetId = '" & txtFleetIDSearch.Text & "'"
        ...
        ElseIf obj.fnVehicleExists(txtFleetIDSearch.Text) = False
            ...
            Exit Sub
        ElseIf txtLicenseNumber.Text = "" Then
            obj.MessageLabel(lblMsg, "Please specify the vehicle's Certificate of Fitness number.", "Red")
            Exit Sub
        End If

        If obj.ExecuteNonQRY(qry) = 1 Then

            qry = "INSERT tbl_CertificatesOfFitnessLicensing (fleetId,licenseNum,dateIssued,expiryDate,commentsNotes) VALUES ('" &
            ...
            End If
        Else
            '  lblMsg.Text = "Error while trying to capture record!"
    ...
    Protected Sub cmdDelete_Click(sender As Object, e As EventArgs) Handles cmdDelete.Click
        ...
        If Not IsNothing(Request.QueryString("op")) Then
            Dim qry As String = "DELETE FROM tbl_CertificatesOfFitnessLicensing  WHERE  (dbo.tbl_CertificatesOfFitnessLicensing.fleetId = '" & (Request.QueryString("op")) & "')"

            obj.ConnectionString = con

            If obj.ExecuteNonQRY(qry) = 1 Then
                obj.MessageLabel(lblMsg, "Certificate of Fitness record entry deleted.", "Green")
            Else
                obj.MessageLabel(lblMsg, "Error while trying to delete Certificate of Fitness record entry.", "Red")
            End If
        Else
            obj.MessageLabel(lblMsg, "Error. System could not find the associated Vehicle Fleet Number.", "Red")
        End If
    End Sub
