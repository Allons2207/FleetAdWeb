...
Public Class ExpiredDDCNotifications
    ...
    Private Sub loadData()
        Dim sql As String = "SELECT        PersonnelNumber, FirstName, LastName, Position, DDC, DATEDIFF(month, GETDATE(), DDC) AS Months, DATEDIFF(day, GETDATE(), DDC) AS DATE
