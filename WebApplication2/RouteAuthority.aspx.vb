...
FROM            dbo.tbluserrolepermission AS k INNER JOIN
    ...
    Private Sub loadExistingVehicleData()
        Dim sql As String = "SELECT * FROM tblROUTE"
        obj.ConnectionString = con
                ...
                For Each row As GridViewRow In GridView1.Rows
                    If TryCast(row.FindControl("chkRow"), CheckBox).Checked Then
                        ...
                        Try
                            ...
                            Dim del = db.GetSqlStringCommand("DELETE FROM  [dbo.tblROUTE] where FLEETID ='" & FLEETID & "'")
                        ...
                        db.AddInParameter(insert1, "@i", System.Data.DbType.String, "RouteAuthority")
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    Using con As New SqlConnection(consString)
                        Using sqlBulkCopy As New SqlBulkCopy(con)
                            ...
                            sqlBulkCopy.DestinationTableName = "dbo.tblROUTE"
...
FROM            dbo.tbluserrolepermission AS k INNER JOIN
        ...
        Try
            ...
            Dim dX As DataSet = db.ExecuteDataSet(CommandType.Text, sql)
            db.ExecuteDataSet(CommandType.Text, sql)
            Dim dSt As DataTable = dX.Tables(0)
