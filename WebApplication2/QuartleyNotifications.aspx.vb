...
Public Class QuartleyNotifications
    ...
    Private Sub loadData()
        Dim sql As String = "SELECT        FLEETID, REGNO, DRIVER, DATE, MILE, DEPT, ENGNO, CHASISNO, LICVALID, LASTDATE, LASTSMILE, NEXTDATE, DEFECTS, DENTS, ELECT, SUSST, WINDMIRR, ACTION, OWNER, ACCID, TEC, AVAYES, 
                         DATEDIFF(month, NEXTDATE, DATE) AS Month
