<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PassDetails.aspx.vb" Inherits="WebApplication2.PassDetails" %>
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav
     ...
     <div class="row mt-5">
  <div class="col-md-8 mb-4 ms-0">
    <div class="card shadow-lg">
      <span class="badge rounded-pill bg-light text-dark w-30 mt-n2 mx-auto">Bus Pass</span>
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <a class="navbar-brand m-0" href="" target="_blank">
                ...
                <img src="/assets/img/mimosa.jpg" class="navbar-brand-img h-10" alt="main_logo">
          ...
          <span class="ps-3 text-bold">Name:</span>
          <span class="ps-3 text-bold">
              <asp:Label ID="txtname" runat="server" Text="Allons Mazani"></asp:Label>
          </span>
        </div>
                      </div>
                      <div class="row">
                          <div class="d-flex justify-content-lg-start  p-2">
          <span class="ps-3 text-bold">Dept:</span>
          <span class="ps-3 text-bold">
              <asp:Label ID="txtdept" runat="server" Text="IT"></asp:Label>
          </span>
        </div>
                      </div>
                       <div class="row">
                          <div class="d-flex justify-content-lg-start p-2">
          <span class="ps-3 text-bold">Pass No:</span>

          <span class="ps-3 text-bold">
              <asp:Label ID="txtT" runat="server" Text="FC100200E"></asp:Label>
          </span>
        </div>
                      </div>
                       <div class="row">
                          <div class="d-flex justify-content-lg-start  p-2">
          <span class="ps-3 text-bold">Nat Reg No:</span>
          <span class="ps-3 text-bold">
              <asp:Label ID="txtID" runat="server" Text="FC100200E"></asp:Label>
          </span>
        </div>
                      </div>
                      <div class="row">
                          <div class="d-flex justify-content-lg-start  p-2">
          <span class="ps-3 text-bold">Contact</span>
          <span class="ps-3 text-bold">
              <asp:Label ID="Label1" runat="server" Text="1234567890"></asp:Label>
          </span>
        </div>
                      </div>
                        ...
                        <div class="row">
                          <div class="d-flex justify-content-lg-start  p-2">
          <span class="ps-3 text-bold">Stakeholders</span>
          <span class="ps-3 text-bold">
              <asp:Label ID="Label2" runat="server" Text="1234567890"></asp:Label>
          </span>
        </div>
                      </div>
                  </div>
            ...
            <div class="avatar-xxl position-relative">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/assets/img/bruce-mars.jpg" class=" w-100 border-radius-lg shadow-sm" alt="profile_image" />
          ...
          <div class="row">
              <div class="row">
                  ...
                  <div class="col-md-10">
                      <div class="row text-center text-bold text-xs">
                          <div class="row">

                          <p class="text-center text-bold text-xs">
                             <pre>
                              Private Bag 638, Zvishavane.Zimbabwe
                              Tel: +263-54-230000/232003/232004/231800/231804
                              Tel/fax:+263-54-229131.Email:info@mimosa.co.zw
                             </pre> 
                          </p>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="" class="font-weight-bold" target="_blank">Vault ITS</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
