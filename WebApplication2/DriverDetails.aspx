<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DriverDetails.aspx.vb" Inherits="WebApplication2.DriverDetails" %>
    ...
    <nav
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Driver Details</h6>
        </nav>
      ...
      <div class="row mb-5">
              ...
              <div class="row mt-4">
                <div class="col-6">
                  <div class="input-group input-group-static">
                    ...
                    <asp:TextBox ID="txtEc" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Position</label>
                  <asp:TextBox ID="txtPos" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
              </div>
        ...
        <Columns>
           <asp:BoundField DataField="Licence/Certificate" HeaderText="Licence/Certificate" />
            <asp:BoundField DataField="TODATE" HeaderText="Expiry Date" />
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-sm-0 mb-4">
                ...
                <div class="w-50 text-end">
                 ...
                 <asp:LinkButton ID="LinkButton1" class="btn btn-outline-secondary mb-3 mb-md-0 ms-auto"   runat="server">Assign</asp:LinkButton>
                </div>
              </div>
            </div>
          </div>
