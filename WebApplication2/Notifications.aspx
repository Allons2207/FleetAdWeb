<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Notifications.aspx.vb" Inherits="WebApplication2.Notifications" %>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse " id="dashboardsExamples1">
                        <ul class="nav ">
                             <li class="nav-item ">
                                 <asp:HyperLink ID="HyperLink17" runat="server" class="nav-link text-white" NavigateUrl="~/BulkInsert.aspx" >
                            ...
                            <li class="nav-item ">
                             ...
                             <li class="nav-item ">
                                 <asp:HyperLink ID="HyperLink18" runat="server" class="nav-link text-white" NavigateUrl="~/MergedLicenses.aspx" >
          ...
          <asp:LinkButton ID="LinkButton3" runat="server"  class="nav-link text-white " OnClick="cof">
                            ...
                            <li class="nav-item ">
                             <asp:LinkButton ID="LinkButton6" runat="server"  class="nav-link text-white " OnClick="abc">
                                    ...
                                    <span class="sidenav-normal  ms-2  ps-1"> Passenger Insurance </span>
                                         ...
                                         <li class="nav-item ">
                                             <asp:HyperLink ID="HyperLink19" runat="server" class="nav-link text-white " NavigateUrl="~/GarageInspections.aspx">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse " id="dashboardsExamplesss">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <asp:HyperLink ID="HyperLink22" runat="server" class="nav-link text-white" NavigateUrl="~/VehiclesTrackit.aspx">
                            ...
                            <li class="nav-item ">
                               <asp:HyperLink ID="HyperLink23" runat="server" class="nav-link text-white" NavigateUrl="~/Vehicles.aspx">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse " id="dashboardsExamples2">
                        <ul class="nav ">
                            ...
                            <li class="nav-item ">
                                <asp:HyperLink ID="HyperLink24" runat="server" class="nav-link text-white" NavigateUrl="~/TripManagement.aspx">
                                    ...
                                    <span class="sidenav-normal  ms-2  ps-1"> Trip Management </span>
                                       ...
                                       <li class="nav-item ">
                                <asp:HyperLink ID="HyperLink25" runat="server" class="nav-link text-white" NavigateUrl="~/Trips.aspx">
                            ...
                            <li class="nav-item ">
                              ...
                              <li class="nav-item "> 
                                  <asp:HyperLink ID="HyperLink26" runat="server" class="nav-link text-white"  NavigateUrl="~/ScheduleList.aspx">
                                    ...
                                    <li class="nav-item "> 
                                  <asp:HyperLink ID="HyperLink27" runat="server" class="nav-link text-white"  NavigateUrl="~/BusPassList.aspx">
                    ...
                    <div class="collapse " id="dashboardsExamples6">
                        <ul class="nav ">
                            <li class="nav-item ">
                                ...
                                <asp:HyperLink ID="HyperLink28" runat="server" class="nav-link text-white" NavigateUrl="~/MorningInspections.aspx">
                            ...
                            <li class="nav-item ">
                                <asp:HyperLink ID="HyperLink29" runat="server" class="nav-link text-white" NavigateUrl="~/QuarterlyInspection.aspx">
                            ...
                            <li class="nav-item ">
                                <asp:HyperLink ID="HyperLink30" runat="server" class="nav-link text-white" NavigateUrl="~/PreTripInspection.aspx">
                            ...
                            <li class="nav-item ">
                               <asp:HyperLink ID="HyperLink31" runat="server" class="nav-link text-white" NavigateUrl="~/PreMaintanceList.aspx">
                    ...
                    <div class="collapse " id="dashboardsExamples00">
                        <ul class="nav ">
                            <li class="nav-item ">
                                ...
                                <asp:HyperLink ID="HyperLink32" runat="server" class="nav-link text-white" NavigateUrl="~/Notifications.aspx">
                    ...
                    <div class="collapse " id="dashboardsExamples7">
                        <ul class="nav ">
                            <li class="nav-item ">
                                ...
                                <asp:HyperLink ID="HyperLink33" runat="server" class="nav-link text-white" NavigateUrl="https://usnconeboxax1aos.cloud.onebox.dynamics.com/">
                            ...
                            <li class="nav-item ">
                               <asp:HyperLink ID="HyperLink34" runat="server" class="nav-link text-white" NavigateUrl="~/Modules/PertentoBI/Dashboard.aspx">
                 ...
                 <hr class="horizontal light mt-0">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse " id="dashboardsExamplesssx">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <asp:HyperLink ID="HyperLink35" runat="server" class="nav-link text-white" NavigateUrl="~/MapFleetUser.aspx">
                            ...
                            <li class="nav-item ">
                               <asp:HyperLink ID="HyperLink36" runat="server" class="nav-link text-white" NavigateUrl="~/MapUsersRolels.aspx">
                              ...
                              <li class="nav-item ">
                               <asp:HyperLink ID="HyperLink37" runat="server" class="nav-link text-white" NavigateUrl="~/MapPermissionToRoles.aspx">
...
<span class="small">11</span>
    ...
    <span class="badge badge-md badge-circle badge-info border border-white border-2">
        <asp:Label ID="txt" runat="server" Text="Label"></asp:Label>
                  ...
                  <div class="d-flex">
                          ...
                          <asp:HyperLink ID="HyperLink15" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/QuartleyNotifications.aspx">
    ...
    <span class="badge badge-md badge-circle badge-info border border-white border-2">
         <asp:Label ID="txtt" runat="server" Text=""></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                     <asp:LinkButton ID="LinkButton11" runat="server" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
                         <i class="ni ni-bold-right" aria-hidden="true"></i>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                   <div class="icon icon-shape icon-sm me-3 bg-gradient-info shadow text-center">
                    ...
                    <div class="d-flex flex-column mt-3">
                                 <button type="button" class="btn btn-outline-info">
    <span>Morning Inspections</span>
    <span class="badge badge-md badge-circle badge-info border border-white border-2">

                                     <asp:Label ID="mn" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                         <asp:HyperLink ID="HyperLink16" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/MorningInspectionNotifcations.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
                      </asp:HyperLink>
          ...
          <div class="card">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">License and Permits(Individual)</h6>
            </div>
            <div class="card-body p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
    ...
    <span>ZBC</span>
    <span class="badge badge-md badge-circle badge-secondary border border-white border-2">
        <asp:Label ID="txtlab" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                      <asp:HyperLink ID="HyperLink1" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/ZBCNOTIFICATIONS.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
                      </asp:HyperLink>
    ...
    <span> COF </span>
    <span class="badge badge-md badge-circle badge-secondary border border-white border-2">
         <asp:Label ID="txtcof" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                      <asp:HyperLink ID="HyperLink3" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/COFNOTIFICATIONS.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
    ...
    <span>ZINARA</span>
    <span class="badge badge-md badge-circle badge-secondary border border-white border-2">
        <asp:Label ID="lblzina" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                      <asp:HyperLink ID="HyperLink2" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/ZINARANofications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
    ...
    <span>Insurance</span>
    <span class="badge badge-md badge-circle badge-secondary border border-white border-2">
                                     <asp:Label ID="txtins" runat="server" Text="Label"></asp:Label>
    </span>
                  ...
                  <div class="d-flex">
                    <asp:HyperLink ID="HyperLink4" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/InsuranceNotifications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
          ...
          <div class="card">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">License and Permits(Bulk)</h6>
            </div>
            <div class="card-body p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
    ...
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">
        <asp:Label ID="txtrute" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                   <asp:HyperLink ID="HyperLink5" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/RouteNotifications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
    ...
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">
                  ...
                  <div class="d-flex">
                       <asp:HyperLink ID="HyperLink6" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/PassengerNotifications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                   <div class="icon icon-shape icon-sm me-3 bg-gradient-danger shadow text-center">
                    ...
                    <div class="d-flex flex-column mt-3">
                                 <button type="button" class="btn btn-outline-danger">
    <span>Sand and Gravel</span>
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">
        <asp:Label ID="txtsan" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                    <asp:HyperLink ID="HyperLink7" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/SandandGravelNotifications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
                  ...
                  <div class="d-flex align-items-center">
                   ...
                   <div class="d-flex flex-column mt-3">
                                 <button type="button" class="btn btn-outline-danger">
    <span>Abnormal Load</span>
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">

                                     <asp:Label ID="txtabl" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                     <asp:HyperLink ID="HyperLink9" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/ABLNotifications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
                  ...
                  <div class="d-flex flex-column mt-3">
                                 <button type="button" class="btn btn-outline-danger">
    <span>Garage Inspections</span>
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">
      
        <asp:Label ID="txtgra" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                        <asp:HyperLink ID="HyperLink8" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/GarageNotifications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
            ...
            <div class="card-body p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    <div class="icon icon-shape icon-sm me-3 bg-gradient-danger shadow text-center">
                      <i class="material-icons opacity-10 pt-2">supervised_user_circle</i>
                    </div>
                   <div class="d-flex flex-column mt-3">
                                 <button type="button" class="btn btn-outline-danger">
    <span>Due Retest</span>
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">
         <asp:Label ID="test" runat="server" Text="Label"></asp:Label>
                  ...
                  <div class="d-flex">
                       <asp:HyperLink ID="HyperLink10" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/RetestNotifications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    <div class="icon icon-shape icon-sm me-3 bg-gradient-danger shadow text-center">
                      ...
                      <div class="d-flex flex-column">
                    <button type="button" class="btn btn-outline-danger">
    <span>Expired DDC</span>
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">
         <asp:Label ID="ddc" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                          </div>
                  </div>
                  <div class="d-flex">
                      <asp:HyperLink ID="HyperLink11" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/ExpiredDDCNotifications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
                  ...
                  <div class="d-flex align-items-center">
                   <div class="icon icon-shape icon-sm me-3 bg-gradient-danger shadow text-center">
                    <i class="material-icons opacity-10 pt-2">supervised_user_circle</i>
                      ...
                      <div class="d-flex flex-column">
                    <button type="button" class="btn btn-outline-danger">
    <span>Expired Medicals Mimosa</span>
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">
         <asp:Label ID="mmgov" runat="server" Text="Label"></asp:Label>
    </span>
  </button></div>
                  </div>
                  <div class="d-flex">
                     <asp:HyperLink ID="HyperLink13" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/ExpiredMedicalsMimosa.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
                  ...
                  <div class="icon icon-shape icon-sm me-3 bg-gradient-danger shadow text-center">
                    ...
                    <div class="d-flex flex-column">
                       <button type="button" class="btn btn-outline-danger">
    <span>Expired Medicals Government</span>
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">
         <asp:Label ID="mmm" runat="server" Text="Label"></asp:Label>
    </span>
  </button>
                  ...
                  <div class="d-flex">
                <asp:HyperLink ID="HyperLink12" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/ExpiredMedicalsGovernment.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
    ...
    <span class="badge badge-md badge-circle badge-danger border border-white border-2">
                  ...
                  <div class="d-flex">
                    <asp:HyperLink ID="HyperLink14" runat="server"  class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" NavigateUrl="~/RestrictedNotications.aspx">
                          <i class="ni ni-bold-right" aria-hidden="true"></i>
          ...
          <div class="card">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">General Nofications</h6>
            </div>
            <div class="card-body p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
    ...
    <span>Vehicles Unavalaible</span>
    <span class="badge badge-md badge-circle badge-warning border border-white border-2">4</span>
  </button>                 
                    </div>
                  </div>
                  <div class="d-flex">
                      <asp:LinkButton ID="LinkButton25" runat="server" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
                         <i class="ni ni-bold-right" aria-hidden="true"></i>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                                        <button type="button" class="btn btn-outline-warning">
    <span>Bus Schedule Notifications</span>
    <span class="badge badge-md badge-circle badge-warning border border-white border-2">4</span>
  </button>
                  ...
                  <div class="d-flex">
                     <asp:LinkButton ID="LinkButton26" runat="server" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
                         <i class="ni ni-bold-right" aria-hidden="true"></i>
    ...
    <span class="badge badge-md badge-circle badge-warning border border-white border-2">4</span>
                  ...
                  <div class="d-flex">
                    <asp:LinkButton ID="LinkButton27" runat="server" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
                         <i class="ni ni-bold-right" aria-hidden="true"></i>
