<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MorningInspections.aspx.vb" Inherits="WebApplication2.MorningInspections" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Morning Inspections</h6>
                </nav>
...
<span class="small">11</span>
                                        ...
                                        <div class="modal-body p-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form role="form text-left">
                                                        <div class="row">
                                                            <h5 class="mb-0">Morning Inspections</h5>
                                                            <hr>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                    ...
                                                                    <asp:TextBox ID="txtFleetID" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                     ...
                                                                     <asp:TextBox ID="txtdate" runat="server" class="form-control datepicker" onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                    <label class="form-label">Wheels</label>
                                                                     <asp:TextBox ID="txtwheel" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                     <label class="form-label">Lights</label>
                                                                     <asp:TextBox ID="txtLight" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                    <label class="form-label">Coolant</label>
                                                                     <asp:TextBox ID="txtcool" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                    ...
                                                                    <asp:TextBox ID="txtbolt" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                           ...
                                                           <div class="row">
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                    <label class="form-label">Suspension</label>
                                                                     <asp:TextBox ID="txtsus" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                    ...
                                                                    <asp:TextBox ID="txtby" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                    <div class="text-center">
                                                                       <asp:Button ID="cmdSave" runat="server" Text="Save" class="btn btn-success mt-3" OnClick="Save" AutoPostBack="True"/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Morning Inspection</h5>
        ...
        <Columns>
            <asp:BoundField DataField="FLEETID" HeaderText="FleetID" />
            <asp:BoundField DataField="DATE" HeaderText="Date" />
            <asp:BoundField DataField="WHEELS" HeaderText="Wheel" />
            <asp:BoundField DataField="LIGHTS" HeaderText="Lights" />
           <asp:BoundField DataField="COOLANT" HeaderText="Coolant" />
            <asp:BoundField DataField="BOLT" HeaderText="Bolt" />
            <asp:BoundField DataField="SUSPENSION" HeaderText="Suspension" />
            <asp:BoundField DataField="INSPBY" HeaderText="Inspector" />
        </Columns>
    </asp:GridView>
 </div>
                </div>
