<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InspectionDetails.aspx.vb" Inherits="WebApplication2.InspectionDetails" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Pre Trip Inspection Details</h6>
                </nav>
                  ...
                  <div class="card">
                    <div class="card-header pt-0 p-3 text-center">
                      <div class="">
                        ...
                        <asp:TextBox ID="txtWorkOrder" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Fleet No</label>
                                <asp:TextBox ID="txtFletID" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                    ...
                    <div class="card-header pt-0 p-3  text-center">
                      <div class="">
                        <div class="col-12">
                            ...
                            <asp:TextBox ID="txtWKSHOP" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="col-lg-4 col-12">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Mechanical</h6>
            </div>
            <div class="card-body pt-4 p-3">
              <ul class="list-group">
                   <asp:GridView ID="GridView1" runat="server" class="table hover data-table-export nowrap" AutoGenerateColumns="false">
        <Columns>
             
            <asp:BoundField DataField="Description" HeaderText="DESCRIPTION" />
            <asp:BoundField DataField="ID" HeaderText="ID"/>
              <asp:TemplateField HeaderText="FAULTY">
            <ItemTemplate>
                  ...
                  <div class ="row">
                      <div class="col-12">
                          <div class="input-group input-group-outline my-3">
                            ...
                            <asp:TextBox ID="txtcommM" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="MultiLine"></asp:TextBox>
                      </div>
                        ...
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtTecMeC" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <span class="input-group-date" id="basic-addon2">Date</span>
                            <asp:TextBox ID="txtDateTec" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                  </div>
          ...
          <div class="card">
            ...
            <div class="card-body pt-4 p-3">
              <ul class="list-group">
                      <asp:GridView ID="GridView2" runat="server" CssClass="table hover data-table-export nowrap" AutoGenerateColumns="false">
        <Columns>
            ...
            <asp:BoundField DataField="Description" HeaderText="DESCRIPTION" />
             ...
             <asp:BoundField DataField="ID" HeaderText="ID"/>
              <asp:TemplateField HeaderText="FAULTY">
            <ItemTemplate>
                <asp:CheckBox ID="chkRowfaulty" runat="server" />
            </ItemTemplate>
        </asp:TemplateField>
                  <asp:TemplateField HeaderText="OK">
            <ItemTemplate>
                <asp:CheckBox ID="chkRowok" runat="server" />
            </ItemTemplate>
        </asp:TemplateField>
        </Columns>
    </asp:GridView>
                   ...
                   <div class="card-footer pt-0 p-3 text-center">
                      ...
                      <div class="col-12">
                          <div class="input-group input-group-outline my-3">
                              <label class="form-label">Comment</label>
                            <asp:TextBox ID="txtCommEE" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="MultiLine"></asp:TextBox>
                      </div>
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Technician</label>
                            <asp:TextBox ID="tecElec" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <span class="input-group-date" id="basic-addon2">Date</span>
                            <asp:TextBox ID="dateTelec" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                  </div>
        ...
        <Columns>
            ...
            <ItemTemplate>
                <asp:CheckBox ID="chkRow1" runat="server" />
                   ...
                   <div class="card-footer pt-0 p-3 text-center">
                      ...
                      <div class="col-12">
                          <div class="input-group input-group-outline my-3">
                              <label class="form-label">Comment</label>
                            <asp:TextBox ID="txtcommee1" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="MultiLine"></asp:TextBox>
                      </div>
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Technician</label>
                            <asp:TextBox ID="tecttyre" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <span class="input-group-date" id="basic-addon2">Date</span>
                            <asp:TextBox ID="datetyre" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                  </div>
               ...
               <div class ="row mt-4">
                   ...
                   <div class="col-lg-4">
                       <div class ="col-12">
                           <asp:Button ID="Button1" runat="server" class="btn btn-lg btn-success w-100" Text="Save" OnClick="Bulk_Insert" />
