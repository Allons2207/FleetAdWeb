...
Public Class PreMaintanceList
    ...
    Private Sub VehicleData()
        Dim sql As String = "SELECT * FROM tblPREMAINTINSP"
    ...
    Protected Sub DownloadFile(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                Response.Redirect("~/PremaintainanceDetails.aspx?op=" + id)
            End If
        Catch ex As Exception
            'log.Error(ex)
        End Try
    ...
    Protected Sub Details(sender As Object, e As EventArgs)
        ...
        Response.Redirect("~/PremaintainanceDetails.aspx")
    End Sub
