...
Imports System.IO
Public Class GarageInspections
...
FROM            dbo.tbluserrolepermission AS k INNER JOIN
    ...
    Private Sub loadExistingVehicleData()
        Dim sql As String = "select * from tblGARAGES"
        obj.ConnectionString = con
...
WHERE        (dbo.ENTASSETFUNCTIONALLOCATION.FUNCTIONALLOCATIONID = N'A650') OR
                         ...
                         (dbo.ENTASSETFUNCTIONALLOCATION.FUNCTIONALLOCATIONID = N'E880')"
        obj.ConnectionString = con
    ...
    Protected Sub DownloadFile(sender As Object, e As EventArgs)
        ...
        Dim Query As String = "SELECT * FROM tblROUTE WHERE ID = '" & id & "'"
                ...
                For Each row As GridViewRow In GridView1.Rows
                    If TryCast(row.FindControl("chkRow"), CheckBox).Checked Then
                        ...
                        Try
                            ...
                            Dim del = db.GetSqlStringCommand("DELETE FROM  [dbo.tblGARAGES] where FLEETID ='" & FLEETID & "'")
                        ...
                        db.AddInParameter(insert1, "@i", System.Data.DbType.String, "Garage Inspection")
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    Using con As New SqlConnection(consString)
                        Using sqlBulkCopy As New SqlBulkCopy(con)
                            ...
                            sqlBulkCopy.DestinationTableName = "dbo.tblGARAGES"
...
FROM            dbo.tbluserrolepermission AS k INNER JOIN
        ...
        Dim Query As String = "DELETE FROM dbo.tblROUTE WHERE ID = '" & id & "'"
...
FROM            dbo.tbluserrolepermission AS k INNER JOIN
        ...
        Dim Query As String = "SELECT * FROM dbo.tblROUTE WHERE ID = '" & id & "'"
