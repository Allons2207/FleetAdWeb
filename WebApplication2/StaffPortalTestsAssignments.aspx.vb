...
Public Class StaffPortalTestsAssignments
    ...
    Protected Sub cmdAddNew_Click(sender As Object, e As EventArgs) Handles cmdAddNew.Click
        ...
        Dim qryString As String = " INSERT INTO [dbo].[tbl_tests] " & _
             ...
             "  ,[description] " & _
             "  ,[schClass], [capturedByEmpNumber]) " & _
        " VALUES " & _
             " ('" & txtTestCode.Text & _
             "' ,'" & cboSubjects.Text & _
             "'  ,'[testName]'" & _
             ...
             "  ,'" & txtNotes.Text & _
             "'  ,'" & cboClasses.Text & "','" & CokkiesWrapper.EmploymentNumber & "') "
    ...
    Private Sub loadDataGrid()
        ...
        Dim sql As String = " SELECT DISTINCT  dbo.tbl_tests.ctr AS Test_Number, dbo.tbl_tests.subject AS Subject, dbo.tbl_tests.stream AS Stream, " & _
            ...
            " dbo.tbl_tests ON dbo.tbl_Files.Title = dbo.tbl_tests.testId  WHERE  dbo.tbl_tests.capturedByEmpNumber = '" & CokkiesWrapper.EmploymentNumber & "'  ORDER BY Test_Number DESC"
