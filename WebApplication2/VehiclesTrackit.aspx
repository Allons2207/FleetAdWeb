<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VehiclesTrackit.aspx.vb" Inherits="WebApplication2.VehiclesTrackit" %>
...
<span class="small">11</span>
      ...
      <div class="row mt-4">
        <div class="col-lg-8 col-12">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">List of All Vehicles Monitored by Trackit</h6>
            </div>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Identifier" HeaderText="Fleet ID" />
            <asp:BoundField DataField="Mileage" HeaderText="Mileage" />
            <asp:BoundField DataField="Location_Area" HeaderText="Country " />
            <asp:BoundField DataField="Location_POI" HeaderText="Location" />
            <asp:BoundField DataField="Speed" HeaderText="Speed" />
            <asp:BoundField DataField="PositionDateTime" HeaderText="Date" />
        </Columns>
    </asp:GridView>
              </ul>
            </div>
