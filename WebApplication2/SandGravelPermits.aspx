<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SandGravelPermits.aspx.vb" Inherits="WebApplication2.SandGravelPermits" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Sand and Gravel</h6>
                </nav>
                                        ...
                                        <div class="modal-body p-0">
                                            <div class="card card-plain">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <h5 class="mb-0">Sand And Gravel Permits</h5>
                                                            <hr>
                                                            <div class="col-6">
            ...
            <asp:BoundField DataField="NAME" HeaderText="Name" />
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-2">
                                                                <div class="input-group input-group-outline-my-3">
                                                                    <div class="text-center">
                                                                       <asp:Button ID="cmdSave" runat="server" Text="Save" class="btn btn-success mt-3" OnClick="Bulk_Insert" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Sand and Gravel</h5>
