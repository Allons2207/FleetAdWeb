<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SchoolAppMaster.Master" CodeBehind="ExaminationPaper.aspx.vb" Inherits="WebApplication2.ExaminationPaper" %>
   ...
   <table width ="75%">
      ...
      <tr><td colspan="4">
       ...
       <tr><td>Examination Date</td><td>
                ...
                <telerik:RadDatePicker ID="rdExamDate" runat="server"></telerik:RadDatePicker>
           
           </td></tr>
       <tr><td>Stream</td><td>
                                 <telerik:RadComboBox ID="cboStreams" runat="server"> </telerik:RadComboBox>
                             </td></tr>
       <tr><td>Subject</td><td><telerik:RadComboBox ID="cboSubject" runat="server"> </telerik:RadComboBox></td></tr>
       <tr><td>Paper</td><td>                       
       ...
       <tr><td>Examination Board</td><td><telerik:RadComboBox ID="cboExamBoard" runat="server"> </telerik:RadComboBox></td></tr>
       <tr><td>Attachment</td><td></td></tr>
       <tr><td></td></tr>
       <tr><td></td><td><asp:Button ID="cmdSaveExam" runat="server" Text="Save Examination" /></td></tr>
       ...
       <tr><td></td></tr>
       <tr><td colspan="4">
                                 <telerik:RadGrid ID="gwExams" runat="server" AllowPaging="True" AllowSorting="True" BackColor="White" BorderColor="#003366" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DisplayMode="FirstLastPreviousNextNumeric, Text" ForeColor="Black" GroupPanelPosition="Top" PageSize="50">
                                     <ClientSettings>
