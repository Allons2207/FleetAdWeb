<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SchoolAppMaster.Master" CodeBehind="ZinaraLicensing.aspx.vb" Inherits="WebApplication2.ZinaraLicensing" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <h3 style="font-size:medium; color:gray "> ZINARA Licensing Details</h3>
...
<tr><td><b>License Details</b></td></tr>
       <tr><td>License Number</td><td> <asp:TextBox ID="txtLicenseNumber" runat="server" Width="212px"></asp:TextBox></td>
        ...
        <tr><td></td><td colspan="3">
                 <asp:Button ID="cmdSave" runat="server" Text="Save License Details" Width="214px" />
                    &nbsp;&nbsp
