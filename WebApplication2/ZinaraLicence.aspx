<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ZinaraLicence.aspx.vb" Inherits="WebApplication2.ZinaraLicence" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">ZINARA Licence</h6>
                </nav>
                                        ...
                                        <div class="modal-body p-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form role="form text-left">
                                                        <div class="row">
                                                            <h5 class="mb-0">ZINARA Details</h5>
                                                            <hr>
                                                            <div class="col-6">
                                                            ...
                                                            <div class="col-2">
                                                                <div class="input-group input-group-outlibe-my-3">
                                                                    <div class="text-center">
                                                                        <asp:Button ID="cmdFleet" runat="server" Text="Find" class="btn btn-outline-success mt-3" AutoPostBack="True"  />
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-2">
                                                                <div class="input-group input-group-outlibe-my-3">
                                                                    <div class="text-center">
                                                                       <asp:Button ID="cmdReg" runat="server" Text="Find" class="btn btn-outline-success mt-3" AutoPostBack="True" OnClick="cmdFleet_Click"/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="input-group input-group-outline my-3">
                                                                    ...
                                                                    <asp:TextBox ID="txtDesvription" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="input-group input-group-dynamic my-3">
                                                                    <span class="input-group-date" id="basic-addon3">Expiry Date</span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="input-group input-group-dynamic my-3">
                                                                    ...
                                                                    <asp:TextBox ID="txtComment" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" TextMode="MultiLine"></asp:TextBox>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="input-group input-group-outline my-3">
                                                                    ...
                                                                    <asp:TextBox ID="txtLicence" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" TextMode="SingleLine"></asp:TextBox>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-2">
                                                                <div class="input-group input-group-outline-my-3">
                                                                    <div class="text-center">
                                                                       <asp:Button ID="cmdSave" runat="server" Text="Save" class="btn btn-success mt-3" AutoPostBack="True" OnClick="cmdSave_Click" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">ZINARA Licence</h5>
        ...
        <Columns>
           ...
           <asp:BoundField DataField="FILE" HeaderText="File Name" /> 
             ...
             <asp:TemplateField HeaderText="Update">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload2" runat="server" Text="Update" OnClick="Update"
                    CommandArgument='<%# Eval("ID") %>'></asp:LinkButton> 
                    </ItemTemplate>  
                </asp:TemplateField>
            <asp:TemplateField HeaderText="Delete">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload3" runat="server" Text="Delete" OnClick="Del"
                    CommandArgument='<%# Eval("ID") %>'></asp:LinkButton> 
                    </ItemTemplate>  
                </asp:TemplateField> 
        </Columns>
