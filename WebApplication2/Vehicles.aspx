<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Vehicles.aspx.vb" Inherits="WebApplication2.Vehicles" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Vehicle List</h6>
                </nav>
...
<span class="small">11</span>
      ...
      <div class="row mt-4">
        <div class="col-lg-3 col-12">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">List of PAV Vehicles</h6>
            </div>
        ...
        <div class="col-lg-3 col-12 mt-md-0 mt-4">
          <div class="card h-100 mb-4">
            <div class="card-header pb-0 px-3">
              <div class="row">
                <div class="col-md-6">
                  <h6 class="mb-0">List of Buses</h6>
                </div>
      ...
      <asp:TemplateField HeaderText="View">  
          ...
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">List of Pools Vehicles</h6>
            </div>
            <div class="card-body pt-4 p-3">
              <ul class="list-group">
        ...
        <div class="col-lg-3 col-12 mt-md-0 mt-4">
          <div class="card h-100 mb-4">
            <div class="card-header pb-0 px-3">
              <div class="row">
                <div class="col-md-6">
                  <h6 class="mb-0">List Surface Equipment</h6>
                </div>
                <div class="col-md-6 d-flex justify-content-start justify-content-md-end align-items-center">
                  <i class="material-icons me-2 text-lg">date_range</i>
                  <small>6 June 2022</small>
            ...
            <div class="card-body pt-4 p-3">
                 <asp:GridView ID="GridView4" runat="server" CssClass="table hover data-table-export nowrap" AutoGenerateColumns="false">
        <Columns>
      <asp:TemplateField HeaderText="View">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload" runat="server" Text="View" oncommand="DownloadFile"
