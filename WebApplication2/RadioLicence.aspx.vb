        ...
        Using fs As Stream = fdfile.PostedFile.InputStream
            Using br As New BinaryReader(fs)
                ...
                Try
                    ...
                    Dim del = db.GetSqlStringCommand("DELETE FROM  [tblZBC] where FLEETID ='" & txtFleetID.Text & "'")
...
FROM            dbo.tbluserrolepermission AS k INNER JOIN
        ...
        Dim Query As String = "DELETE FROM tblZBC WHERE ID = '" & id & "'"
