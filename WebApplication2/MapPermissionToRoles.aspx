<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MapPermissionToRoles.aspx.vb" Inherits="WebApplication2.MapPermissionToRoles" %>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Map Users to Roles</h6>
                </nav>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body p-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                            <h5 class="mb-0">Map Roles to Permissions</h5>
                                                            <hr>
                                                            <div class="col-6">
