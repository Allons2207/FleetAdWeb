<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BulkInsert.aspx.vb" Inherits="WebApplication2.BulkInsert" %>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Bulk Insert Permits</h6>
                </nav>
                                        ...
                                        <div class="modal-body p-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form role="form text-left">
                                                        <div class="row">
                                                            <h5 class="mb-0">Bulk Licence Upload</h5>
                                                            <hr>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-2">
                                                                <div class="input-group input-group-outline-my-3">
                                                                    <div class="text-center">
                                                                       <asp:Button ID="cmdSave" runat="server" Text="Save" class="btn btn-success mt-3" AutoPostBack="True" OnClick="Upload"/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <div class="col-lg-12 col-12">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Bulk Insert Licences</h6>
            </div>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            <a href="https://www.creative-tim.com/" class="font-weight-bold" target="_blank">Vault ITS</a> for a better web.
                        </div>
                    </div>
                    <div class="col-lg-6">
