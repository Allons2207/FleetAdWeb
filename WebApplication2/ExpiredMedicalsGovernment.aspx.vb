...
Public Class ExpiredMedicalsGovernment
    ...
    Private Sub loadData()
        Dim sql As String = "SELECT        PersonnelNumber, FirstName, LastName, Position, DATEDIFF(month, GETDATE(), [AU-DRVE]) AS Months, DATEDIFF(day, GETDATE(), [AU-DRVE]) AS DATE, [MED-GOV]
