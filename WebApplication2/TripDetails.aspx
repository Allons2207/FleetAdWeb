<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TripDetails.aspx.vb" Inherits="WebApplication2.TripDetails" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Trip Details</h6>
                </nav>
                  ...
                  <div class="card">
                    <div class="card-header pt-0 p-3 text-center">
                      <div class="">
                        ...
                        <asp:TextBox ID="txtreid" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Requestor</label>
                                <asp:TextBox ID="txtre" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label"> Request Date</label>
                                 <asp:TextBox ID="txtredate" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                  ...
                  <div class="card">
                    <div class="card-header pt-0 p-3  text-center">
                      <div class="">
                        <div class="col-12">
                            ...
                            <asp:TextBox ID="txtdept" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                      </div>
                    </div>
                    <div class="card-body pt-0 p-3 text-center">
                        ...
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtdest" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Local or Non Local Travel</label>
                            <asp:TextBox ID="txtloc" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                  </div>
            ...
            <div class="card-body pt-4 p-3">
               <div class="row">
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtnature" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                            <label class="form-label">Approximate Weight of Goods</label>
                            <asp:TextBox ID="txtweight" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="row">
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtreqtype" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                                  <label class="form-label">Number of People/Passengers Travelling</label>
                            <asp:TextBox ID="txtnumpp" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                 <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                             <label class="form-label">Expected Time of Departure</label>
                            <asp:TextBox ID="txttimedep" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                               <label class="form-label">Expected Departure Date </label>
                            <asp:TextBox ID="txtdatedep" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                 <div class="row">
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtarrdatae" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                             <label class="form-label">Expected Time of Arrival</label>
                            <asp:TextBox ID="txtarrtime" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                 <div class="row">
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtcontper" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                             <label class="form-label">Contact Person Contact Number</label>
                            <asp:TextBox ID="txtconnum" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" disabled="true" ></asp:TextBox>
                            </div>
                        </div>
                    </div>
                         <div class="row">
                        <div class="col-6">
                           ...
                           <label for="DropDownList1" class="ms-0">Allocate Vehicle</label>
                                <asp:DropDownList ID="veh" runat="server" class="form-control">
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-static mb-4">
                           <label for="DropDownList3" class="ms-0">Allocate Drive</label>
                                <asp:DropDownList ID="drivr" runat="server" class="form-control">
        ...
        <div class="col-lg-4 col-12 mt-md-0 mt-4">
          <div class="card h-100 mb-4">
            <div class="card-header pb-0 px-3">
              <div class="row">
                <div class="col-md-6">
                  <h6 class="mb-0">Route Instructions</h6>
                </div>
            ...
            <div class="card-body pt-4 p-3">
                    <div class="row">
                        <div class="col-12">
                           ...
                           <label class="form-label">Route Instruction</label>
                            <asp:TextBox ID="txtins" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="MultiLine" ></asp:TextBox>
                        </div>
                            </div>
               ...
               <div class ="row mt-4">
                   ...
                   <div class="col-lg-4">
                       <div class ="col-12">
                           <asp:Button ID="Button1" runat="server" Text="Save" class="btn btn-lg btn-success w-100" OnClick="Button1_Click"/>
