<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VehicleList.aspx.vb" Inherits="WebApplication2.VehicleList" %>
              ...
              <div class="row">
                <div class="col-md-6 col-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Vehicles</h6>
                      <span class="text-xs">Under Maintance</span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0">0</h5>
                    </div>
                  </div>
                ...
                <div class="col-md-6 col-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Vehicles</h6>
                      <span class="text-xs">Decommisioned</span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0">0</h5>
                    </div>
                  </div>
        ...
        <div class="col-lg-7 col-12">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">List of All Vehicles</h6>
            </div>
        ...
        <div class="col-lg-5 col-12 mt-md-0 mt-4">
          <div class="card h-100 mb-4">
            <div class="card-header pb-0 px-3">
              <div class="row">
                <div class="col-md-6">
                  <h6 class="mb-0">List of Available Vehicles</h6>
                </div>
