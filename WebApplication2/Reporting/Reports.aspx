<%@ Page Language="vb" AutoEventWireup="False" MasterPageFile="~/SchoolAppMaster.Master"
    CodeBehind="Reports.aspx.vb" Inherits="WebApplication2.Reports" Title="Reports" EnableSessionState="True"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" EnableViewState="true">
    &nbsp;<script type="text/javascript" src="Scripts/Cookies.js"></script><script language="javascript" type="text/javascript">
    ...
    </script><table border="0" cellpadding="0" cellspacing="0" style="width: 100%; margin-left:2%">
        <tr>
