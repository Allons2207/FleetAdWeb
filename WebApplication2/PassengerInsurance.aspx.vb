...
FROM            dbo.tbluserrolepermission AS k INNER JOIN
        ...
        Dim Query As String = "DELETE FROM tblPASS WHERE ID = '" & id & "'"
...
FROM            dbo.tbluserrolepermission AS k INNER JOIN
        ...
        Dim Query As String = "SELECT * FROM dbo.tblPASS WHERE ID = '" & id & "'"
    ...
    Private Sub loadExistingVehicleData()
        Dim sql As String = "SELECT * FROM tblPASS"
        obj.ConnectionString = con
...
WHERE        (dbo.ENTASSETFUNCTIONALLOCATION.FUNCTIONALLOCATIONID = N'A650') OR
    ...
    Protected Sub DownloadFile(sender As Object, e As EventArgs)
        ...
        Dim Query As String = "SELECT * FROM tblPASS WHERE ID = '" & id & "'"
                ...
                For Each row As GridViewRow In GridView1.Rows
                    If TryCast(row.FindControl("chkRow"), CheckBox).Checked Then
                        ...
                        Try
                            ...
                            Dim del = db.GetSqlStringCommand("DELETE FROM  [dbo.tblPASS] where FLEETID ='" & FLEETID & "'")
                        ...
                        db.AddInParameter(insert1, "@i", System.Data.DbType.String, "PassengerInsurance")
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    Using con As New SqlConnection(consString)
                        Using sqlBulkCopy As New SqlBulkCopy(con)
                            ...
                            sqlBulkCopy.DestinationTableName = "dbo.tblPASS"
