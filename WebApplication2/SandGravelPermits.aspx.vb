...
Public Class SandGravelPermits
...
WHERE        (dbo.ENTASSETFUNCTIONALLOCATION.FUNCTIONALLOCATIONID = N'E880')"
        obj.ConnectionString = con
...
FROM            dbo.tbluserrolepermission AS k INNER JOIN
        ...
        Dim Query As String = "DELETE FROM tblSANDANDGRAVEL WHERE ID = '" & id & "'"
                ...
                For Each row As GridViewRow In GridView1.Rows
                    If TryCast(row.FindControl("chkRow"), CheckBox).Checked Then
                        ...
                        Try
                            ...
                            Dim del = db.GetSqlStringCommand("DELETE FROM  [tblSANDANDGRAVEL] where FLEETID ='" & FLEETID & "'")
                        ...
                        db.AddInParameter(insert1, "@i", System.Data.DbType.String, "SandandGravel")
