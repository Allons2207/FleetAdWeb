<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DriverList.aspx.vb" Inherits="WebApplication2.DriverList" %>
    ...
    <nav
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Drivers List</h6>
        </nav>
            ...
            <div class="col-lg-6 col-md-6 col-12 mb-4">
              <div class="card">
                <div class="card-header p-3 py-2">
                  ...
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Restricted Drivers</p>
                    <h4 class="mb-0">1</h4>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6 col-md-6 col-12">
              <div class="card">
                <div class="card-header p-3 py-2">
                  ...
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">On trip</p>
                    <h4 class="mb-0">0</h4>
                  </div>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-12 mt-4 mt-md-0">
              <div class="card">
                <div class="card-header p-3 py-2">
                  ...
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Available</p>
                    <h4 class="mb-0">26</h4>
                  </div>
                </div>
          ...
          <div class="card">
              <div class="card-header">
                        ...
                        <p class="text-sm mb-0">
                           General Pool Drivers
                        </p>
                    </div>
                              <div class="table-responsive">
                         <asp:GridView ID="gvCustomers" runat="server" CssClass="table hover data-table-export nowrap" AutoGenerateColumns="false">
        <Columns>
           <asp:BoundField DataField="PERSONNELNUMBER" HeaderText="Employment #" />
            <asp:BoundField DataField="FIRSTNAME" HeaderText="Name" />
            <asp:BoundField DataField="LASTNAME" HeaderText="Last Name" />
            <asp:BoundField DataField="DESCRIPTION" HeaderText="Position" />
            <asp:BoundField DataField="DriverCategory" HeaderText="Category" />
            <asp:BoundField DataField="Employer" HeaderText="Employer" />
                <asp:BoundField DataField="Fitness" HeaderText="Fitness" />
             <asp:BoundField DataField="Outcome" HeaderText="Outcome" />
           
                <asp:TemplateField HeaderText="View">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload" runat="server" Text="View" oncommand="DownloadFile"
                    CommandArgument='<%# Eval("PERSONNELNUMBER") %>'></asp:LinkButton> 
                    </ItemTemplate>  
                </asp:TemplateField>
        </Columns>
    </asp:GridView>
