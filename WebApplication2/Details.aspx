<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Details.aspx.vb" Inherits="WebApplication2.Details" %>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse " id="dashboardsExamples1">
                        <ul class="nav ">
                            ...
                            <li class="nav-item ">
                                <asp:LinkButton ID="LinkButton2" runat="server"  class="nav-link text-white " OnClick="Zinara">
                            ...
                            <li class="nav-item ">
                                <asp:LinkButton ID="LinkButton3" runat="server"  class="nav-link text-white " OnClick="Zbc">
                            ...
                            <li class="nav-item ">
          <asp:LinkButton ID="LinkButton4" runat="server"  class="nav-link text-white " OnClick="cof">
                            ...
                            <li class="nav-item ">
                               <asp:LinkButton ID="LinkButton5" runat="server"  class="nav-link text-white " OnClick="rute">
                            ...
                            <li class="nav-item ">
                              <asp:LinkButton ID="LinkButton6" runat="server"  class="nav-link text-white " OnClick="san">
                            ...
                            <li class="nav-item ">
                             <asp:LinkButton ID="LinkButton7" runat="server"  class="nav-link text-white " OnClick="abc">
                                    ...
                                    <span class="sidenav-normal  ms-2  ps-1"> Abnormal Load </span>
                                         ...
                                         <li class="nav-item ">
                                        <asp:LinkButton ID="LinkButton8" runat="server"  class="nav-link text-white " OnClick="pas">
          ...
          <div class="card mt-4" id="basic-info">
            ...
            <div class="card-body pt-0">
              <div class="row">
                           ...
                           <label for="DropDownList1" class="ms-0">FleetID</label>
                                <asp:DropDownList ID="DropDownList1" runat="server" class="form-control" OnSelectedIndexChanged="DownloadFile" AutoPostBack="true">
                 ...
                 <div class="row">
                                ...
                                <div class="col-6">
                                                                <div class="input-group input-group-static my-3">
                                                                    ...
                                                                    <asp:TextBox ID="txtreg" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
              ...
              <div class="row mt-4">
                <div class="col-6">
                  <div class="input-group input-group-static">
                    ...
                    <asp:TextBox ID="txtlic" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Comment</label>
                  <asp:TextBox ID="txcommzin" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
              </div>
                ...
                <div class="col-6">
                  <div class="input-group input-group-static">
                    ...
                    <asp:TextBox ID="txtstartzin" runat="server"  class="form-control" TextMode="Date"></asp:TextBox>
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Date Expiry</label>
                  <asp:TextBox ID="txtendzin" runat="server"  class="form-control" TextMode="Date"></asp:TextBox>
                  </div>
                </div>
              </div>
                 <div class="row mt-2 mb-2 text-center">
              ...
              <div class="row mt-4">
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Licence Number</label>
                    <asp:TextBox ID="txtliczb" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Comment</label>
                  <asp:TextBox ID="txtcommzb" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
              </div>
                ...
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Date Issued</label>
                    <asp:TextBox ID="txtstartzb" runat="server"  class="form-control" TextMode="Date"></asp:TextBox>
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Date Expiry</label>
                  <asp:TextBox ID="txtendzb" runat="server"  class="form-control" TextMode="Date"></asp:TextBox>
                  </div>
                </div>
              </div>
         <div class="row mt-2 mb-2 text-center">
              ...
              <div class="row mt-4">
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Licence Number</label>
                    <asp:TextBox ID="txtlicin" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Comment</label>
                  <asp:TextBox ID="txtxcommin" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
              </div>
                ...
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Date Issued</label>
                    <asp:TextBox ID="txtstartin" runat="server"  class="form-control" TextMode="Date"></asp:TextBox>
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Date Expiry</label>
                  <asp:TextBox ID="txtendin" runat="server"  class="form-control" TextMode="Date"></asp:TextBox>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-sm-0 mb-4">
                ...
                <div class="w-50 text-end">
                 ...
                 <asp:LinkButton ID="LinkButton1" class="btn btn-lg btn-success mb-3 mb-md-0 ms-auto"   runat="server" OnClick="cmdSave">Save</asp:LinkButton>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <a class="btn bg-gradient-primary w-100" href="/product/material-dashboard-pro">Buy now</a>
        <a class="btn bg-gradient-info w-100" href="/product/material-dashboard">Free demo</a>
        <a class="btn btn-outline-dark w-100" href="/learning-lab/bootstrap/overview/material-dashboard">View
          documentation</a>
        <div class="w-100 text-center">
          ...
          <a href="https://twitter.com/intent/tweet?text=Check%20Material%20UI%20Dashboard%20PRO%20made%20by%20%40CreativeTim%20%23webdesign%20%23dashboard%20%23bootstrap5&amp;url=https%3A%2F%%2Fproduct%2Fsoft-ui-dashboard-pro"
            class="btn btn-dark mb-0 me-2" target="_blank">
            <i class="fab fa-twitter me-1" aria-hidden="true"></i> Tweet
          </a>
          <a href="https://www.facebook.com/sharer/sharer.php?u=/product/material-dashboard-pro"
            class="btn btn-dark mb-0 me-2" target="_blank">
