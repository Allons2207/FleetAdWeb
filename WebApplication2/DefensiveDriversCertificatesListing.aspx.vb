...
Public Class DefensiveDriversCertificatesListing
    ...
    Protected Sub cmdAddNew_Click(sender As Object, e As EventArgs) Handles cmdAddNew.Click
        Response.Redirect("~/DefensiveDriversCertificateDetails.aspx")
    End Sub

    Private Sub loadList()

        Dim sql As String = "SELECT DISTINCT  Convert(VARCHAR(10), dbo.tbl_vehicleUserDDCs.examDate, 10) AS ExamDate, " &
                            "  Convert(VARCHAR(10), dbo.tbl_vehicleUserDDCs.expiryDate, 10) AS ExpiryDate, dbo.tbl_vehicleUserDDCs.licenseNumber AS LicenseNumber, " &
                            ...
                            " DateDiff(MM, GETDATE(), dbo.tbl_vehicleUserDDCs.expiryDate) As MonthsToExpiryDate FROM  dbo.tbl_vehicleUserDDCs INNER JOIN dbo.tbl_vehicleUsers ON dbo.tbl_vehicleUserDDCs.licenseNumber = " &
    ...
    Private Sub gwGrid_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles gwGrid.ItemCommand
        If e.CommandName = "View" Then
            ...
            Response.Redirect("~/DefensiveDriversCertificateDetails.aspx?op=" + LicenseNo)
        End If
    End Sub
