<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PreTripInspection.aspx.vb" Inherits="WebApplication2.PreTripInspection" %>
...
<span class="small">11</span>
                ...
                <div class="col-sm-2 mt-2 text">
                    <div class="text-center">
                        <div class="col-md-6 text-center">
                            <asp:Button ID="Button1" runat="server" Text="Add New" class="btn b-lg-block bg-gradient-warning mb-3 modal-dialog-centered mt-3 text-bold" OnClick="Details" />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="LOCATION" HeaderText="Workshop" />
            <asp:BoundField DataField="MAKE" HeaderText="MAKE" />
           <asp:BoundField DataField="MILE" HeaderText="MILEAGE" />
