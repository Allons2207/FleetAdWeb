<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TransportReceipt.aspx.vb" Inherits="WebApplication2.TransportReceipt" %>
                       ...
                       <div id ="bill" >
                                  <%-- the content will be printed --%>
                                    <table class="watermark" >
                                        ...
                                        <tr><td colspan="2" class="receiptHeader" style="text-align:center;font-weight:bolder">Transport Payment Receipt</td></tr>
