<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ScheduleDetails.aspx.vb" Inherits="WebApplication2.ScheduleDetails" %>
            ...
            <div class="card-body pt-0">
              <div class="row">
                           ...
                           <label for="DropDownList1" class="ms-0">FleetID</label>
                                ...
                                <div class="col-6">
                                     <div class="input-group input-group-static mb-4">
                           <label for="DropDownList1" class="ms-0">Driver</label>
              ...
              <div class="row mt-4">
                ...
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label></label>
                  <asp:TextBox ID="txtdate" runat="server"  class="form-control" TextMode="Time" format="HH:mm"></asp:TextBox>
                  </div>
                </div>
              </div>
              <div class="row mt-4">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-sm-0 mb-4">
                ...
                <div class="w-50 text-end">
                 ...
                 <asp:LinkButton ID="LinkButton1" class="btn btn-outline-secondary mb-3 mb-md-0 ms-auto"   runat="server" OnClick="Open">Save</asp:LinkButton>
                </div>
              </div>
            </div>
          </div>
