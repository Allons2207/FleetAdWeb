<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SchoolAppMaster.Master" CodeBehind="SetLevyPayments.aspx.vb" Inherits="WebApplication2.SetLevyPayments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <table width ="100%">
            <tr>
                <td>
                      <telerik:RadGrid ID="gwLevyPaymentsSchedule" runat="server" Width ="100%"  BackColor="#DEBA84"  AllowPaging="True"  DisplayMode="FirstLastPreviousNextNumeric, Text" PageSize="50"
         ...
         <MasterTableView DataKeyNames="LevyPaymentId">
             <Columns>
