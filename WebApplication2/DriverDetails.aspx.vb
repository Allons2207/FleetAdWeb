...
Public Class DriverDetails
    ...
    Private Sub loadDriversData()
        Dim sql As String = "select * from vwdriversnew where PERSONNELNUMBER ='" & Request.QueryString("op") & "'"
        ...
        Try
            ...
            TextBox1.Text = dt.Rows(0).Item("FIRSTNAME").ToString
            txtSname.Text = dt.Rows(0).Item("LASTNAME").ToString
            txtPos.Text = dt.Rows(0).Item("DESCRIPTION").ToString
            txtEc.Text = dt.Rows(0).Item("PERSONNELNUMBER").ToString
