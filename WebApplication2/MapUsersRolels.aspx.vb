...
Public Class MapUsersRolels
    ...
    Private Sub loadExistingVehicleData()
        ...
        Dim sql As String = " select i.ID ,i.Username,k.Description from tbluserrole i inner join  tblROLES  k on i.ROLE=k.ID"
        ...
        If dt.Rows.Count > 0 Then
            ...
            Using con As New SqlConnection(consString)
                Using sqlBulkCopy As New SqlBulkCopy(con)
                    ...
                    sqlBulkCopy.DestinationTableName = "dbo.tbluserrole"
