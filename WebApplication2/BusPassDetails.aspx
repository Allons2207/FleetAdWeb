<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BusPassDetails.aspx.vb" Inherits="WebApplication2.BusDetails" %>
          ...
          <asp:LinkButton ID="LinkButton4" runat="server"  class="nav-link text-white " OnClick="cof">
                            ...
                            <li class="nav-item ">
                             <asp:LinkButton ID="LinkButton7" runat="server"  class="nav-link text-white " OnClick="abc">
                                    ...
                                    <span class="sidenav-normal  ms-2  ps-1"> Passenger Insurance </span>
                                         ...
                                         <li class="nav-item ">
                                             <asp:LinkButton ID="LinkButton9" runat="server"  class="nav-link text-white ">
                                    ...
                                    <span class="sidenav-normal  ms-2  ps-1"> Garage Inspections </span>
                                         ...
                                         <li class="nav-item ">
                                          ...
                                          <asp:LinkButton ID="LinkButton10" runat="server"  class="nav-link text-white " OnClick="garage">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse " id="dashboardsExamples">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <asp:LinkButton ID="LinkButton11" CssClass="nav-link text-white" runat="server" OnClick="drvlist">
                            ...
                            <li class="nav-item ">
                            <asp:LinkButton ID="LinkButton12" runat="server" class="nav-link text-white" OnClick="drvrestrict">


                                    <span class="sidenav-mini-icon"> RS </span>
                                    <span class="sidenav-normal  ms-2  ps-1"> Restricted Drivers </span>
                            </asp:LinkButton>
                  ...
                  <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#dashboardsExamples2" class="nav-link text-white " aria-controls="dashboardsExamples" role="button" aria-expanded="false">
                        <i class="material-icons-round opacity-10">dashboard</i>
                        <span class="nav-link-text ms-2 ps-1">Vehicle Trip Management</span>
                    </a>
                    <div class="collapse " id="dashboardsExamples2">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <asp:LinkButton ID="LinkButton13" runat="server" class="nav-link text-white" OnClick="vehiclelist">
                            ...
                            <li class="nav-item ">
                                <asp:LinkButton ID="LinkButton14" runat="server" class="nav-link text-white">
                            ...
                            <li class="nav-item ">
                                <asp:LinkButton ID="LinkButton15" runat="server" class="nav-link text-white" OnClick="bus">
    ...
    <nav
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Bus Scheduling</h6>
        </nav>
            ...
            <div class="card-body pt-0">
              <div class="row mt-4">
                <div class="col-6">
                  <div class="input-group input-group-static">
                    ...
                    <asp:TextBox ID="txtdty" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-group input-group-static">
              ...
              <div class="row mt-4">
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Pass NO </label>
                     <asp:TextBox ID="txtfrm" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>National Reg Number</label>
                ...
                <div class="col-6">
                  <div class="input-group input-group-static">
                    <label>Phone Number </label>
                     <asp:TextBox ID="txtNUMB" runat="server"  class="form-control"></asp:TextBox>
                  </div>
                </div>
       <div class="col-6">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-sm-0 mb-4">
                ...
                <div class="w-50 text-end">
                    <asp:Button ID="Button1" class="btn btn-success mb-3 mb-md-0 ms-auto"   runat="server" OnClick="Open" Text=" Save " />
