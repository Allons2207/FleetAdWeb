<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="PertentoBI.Header" %>

<div class="demo-header-part demo-area-highlight">
    <dx:BootstrapToolbar runat="server" ClientInstanceName="HeaderToolbar">
