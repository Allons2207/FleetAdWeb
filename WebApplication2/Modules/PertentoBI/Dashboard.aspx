<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Dashaboard.master" CodeBehind="Dashboard.aspx.cs" Inherits="Dashboard" ValidateRequest="false" UICulture="en" Culture="en-ZA" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dashboard" style="position: absolute; left: 0; right: 50px; top: 120px; bottom: 0;">
        <div id="myPopup"></div>
        ...
        <dx:ASPxDashboard ID="ASPxDashboard1" runat="server"
            ...
            UseNeutralFilterMode="true" ColorScheme="light" OnCustomJSProperties="ASPxDashboard1_CustomJSProperties" OnCustomDataCallback="ASPxDashboard1_CustomDataCallback">
