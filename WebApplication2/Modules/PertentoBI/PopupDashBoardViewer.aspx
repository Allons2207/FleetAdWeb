<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PopupDashBoardViewer.aspx.cs" Inherits="PertentoBI.PopupDashBoardViewer" %>
...
<%--    <script type="text/javascript" src='Content/Custom_Items/SaveAsExtension.js'></script>
    ...
    <script type="text/javascript">
        ...
        function onBeforeRender(sender, e) {
            ...
            ////var extension = new CustomDashboardPanelExtension(innerControl)
