...
namespace PertentoBI
{
    ...
    public partial class PopupDashBoardViewer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //  objBus = new Docwize.cDWMain.cDWBusTier(cCookies.CompanyLogin, General.getServerName(), cCookies.AuditUser);
            ...
            //  RegisterDataSourceWizardDBSchemaProviderExFactory<CustomDataSourceWizardDBSchemaProviderFactory>();
