...
<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="DashboardViewer.aspx.cs" Inherits="DashboardViewer"  UICulture="en" Culture="en-ZA"  %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <script type="text/javascript" src ="Scripts/Lib/js/jszip.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function onBeforeRender(sender, e) {
          ...
          //  extension.allowSwitchToDesigner(false);
            ...
            //innerControl.registerExtension(new OnlineMapItemExtension(sender));
...
<%--    <script type="text/javascript" src="Content/Custom_Items/dashboard-extensions/parameter-item.js"></script>
    ...
    <div id="dashboard" style="position: absolute; left: 0; right: 0; top: 80px; bottom: 0;">
        <div id="myPopup"></div>
       ...
       <dx:ASPxDashboard ID="ASPxDashboard1" runat="server"
            ...
            UseNeutralFilterMode="true" ColorScheme="light.compact" OnCustomJSProperties="ASPxDashboard1_CustomJSProperties" OnCustomDataCallback="ASPxDashboard1_CustomDataCallback"  >
