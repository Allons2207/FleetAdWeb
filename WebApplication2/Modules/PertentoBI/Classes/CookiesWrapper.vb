...
Partial Public Class CookiesWrapper1
...
#Region "User Cookies"
    ...
    <Description("Gets or sets a ApplicationSkin saved into the ApplicationSkin cookie.")>
    Public Shared Property ApplicationSkinCSS() As String
        Get
            Return GetCookie("ApplicationSkinCSS", "ApplicationSkins/mms/styles/mms.css")
        End Get
        Set(ByVal Value As String)
            AddCookie("ApplicationSkinCSS", Value)
        End Set
    End Property
...
#Region "User Cookies"
    ...
    Public Shared Property ConnectionName() As String
        Get
            Return GetCookie("ConnectionName", "Test")
        End Get
        Set(ByVal Value As String)
    ...
    Public Shared Property AdHocMessage() As String
        Get
            Return GetCookie("AdHocMessage", "Test")
        End Get
        Set(ByVal Value As String)
