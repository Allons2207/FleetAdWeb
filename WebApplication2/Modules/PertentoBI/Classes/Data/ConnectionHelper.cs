...
public static class ConnectionHelper
{
    static Type[] persistentTypes = new Type[] {
           // typeof(Audit),
            typeof(Categories),
            typeof(DashboardDatasources),
            typeof(Dashboards),
            typeof(DatasourceCategories),
            typeof(DataSources),
            typeof(GlobalSettings),
       //     typeof(Menu),
            typeof(ReportDatasources),
            typeof(Reports),
            typeof(SystemImages),
            typeof(UserDashboardAccessRights),
            typeof(UserDatasourceAccessRights),
            typeof(UserReportAccessRights),
        };
    ...
    public static string ConnectionString
    {
        get
        {
            return System.Configuration.ConfigurationManager.ConnectionStrings[CookiesWrapper.thisConnectionName].ConnectionString;
        }
    }
