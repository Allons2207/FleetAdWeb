<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="EventScheduling.aspx.cs" Inherits="PertentoBI.EventScheduling" %>
...
<asp:Content runat="server" ContentPlaceHolderID="mainContent">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server"
        DataObjectTypeName="PertentoBI.SchedulerAppointment"
        TypeName="PertentoBI.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server"
        DataObjectTypeName="PertentoBI.SchedulerResource"
        TypeName="PertentoBI.ResourceDataSourceHelper"
