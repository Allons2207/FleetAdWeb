<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MergedLicenses.aspx.vb" Inherits="WebApplication2.MergedLicenses" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">ZBC,ZINARA Licence & Insurance</h6>
                </nav>
...
<span class="small">11</span>
                ...
                <div class="col-sm-2 mt-2 text">
                    <div class="text-center">
                        <div class="col-md-6 text-center">
                            ...
                            <asp:Button ID="Button1" runat="server" class="btn btn-lg bg-gradient-warning mb-3 modal-dialog-centered mt-3 text-bold " Text="Add New"  OnClick="Details"/>
        ...
        <Columns>
           ...
           <asp:BoundField DataField="FILE" HeaderText="File Name" /> 
                <asp:TemplateField HeaderText="DOWNLOAD">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload5" runat="server" Text="Download" OnClick="DownloadFilezin"
                    CommandArgument='<%# Eval("ID") %>'></asp:LinkButton> 
                    </ItemTemplate>  
                </asp:TemplateField> 
            <asp:TemplateField HeaderText="View">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload6" runat="server" Text="View" OnCommand="View"
                    CommandArgument='<%# Eval("FLEETID") %>'></asp:LinkButton> 
                    </ItemTemplate>  
                </asp:TemplateField> 
        </Columns>
    </asp:GridView>
        ...
        <Columns>
           ...
           <asp:BoundField DataField="FILE" HeaderText="File Name" /> 
                <asp:TemplateField HeaderText="DOWNLOAD">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload4" runat="server" Text="Download" OnClick="DownloadFilezb"
                    CommandArgument='<%# Eval("ID") %>'></asp:LinkButton> 
                    </ItemTemplate>  
                </asp:TemplateField> 
             <asp:TemplateField HeaderText="View">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload3" runat="server" Text="View" OnCommand="View"
                    CommandArgument='<%# Eval("FLEETID") %>'></asp:LinkButton> 
                    </ItemTemplate>  
                </asp:TemplateField> 
        </Columns>
        ...
        <Columns>
           ...
           <asp:BoundField DataField="FILE" HeaderText="File Name" /> 
                <asp:TemplateField HeaderText="DOWNLOAD">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload2" runat="server" Text="Download" OnClick="DownloadFilein"
                    CommandArgument='<%# Eval("ID") %>'></asp:LinkButton> 
                    </ItemTemplate>  
                </asp:TemplateField> 
             <asp:TemplateField HeaderText="View">  
                    <ItemTemplate>  
                                 <asp:LinkButton ID="lnkDownload1" runat="server" Text="View" OnCommand="View"
                    CommandArgument='<%# Eval("FLEETID") %>'></asp:LinkButton> 
                    </ItemTemplate>  
                </asp:TemplateField> 
        </Columns>
