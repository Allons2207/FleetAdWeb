...
FROM            (SELECT        A.OBJECTID, dbo.ENTASSETOBJECTTYPE.NAME AS TYPE, dbo.ENTASSETPRODUCT.DESCRIPTION AS PRODUCT_NAME_MAKE, dbo.ENTASSETMODEL.DESCRIPTION AS MODEL, A.NAME, A.NOTES, 
            ...
            Try
                ...
                Labelss.Text = "Buses:" + " " + dt.Rows(0).Item("Count").ToString
    ...
    Private Sub loadDriversData()
        Dim sql As String = "Select * FROM tblBUSSCHEEDULE"
        obj.ConnectionString = con
        ...
        Try
            For Each dr As GridViewRow In gvCustomers.Rows
                If dr.RowType = DataControlRowType.DataRow Then
                    ...
                    Dim aa = dr.Cells(3).Text
                    Dim splitcheck = Split(aa, ":")
                    Dim axc = TimeOfDay.ToString("hh:mm:ss")
                    ...
                    ElseIf balance < 15 Then
                        ...
                        chkRow.Text = "Close to Onsert"
                    Else
                        chkRow.CssClass = "btn bg-gradient-success"
                        chkRow.Text = "Pending"
                    End If
...
WHERE        (HJ.DESCRIPTION LIKE '%driver%')"
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                Response.Redirect("~/ScheduleDetails.aspx?op=" + id)
            End If
        Catch ex As Exception
            'log.Error(ex)
        End Try
    ...
    Protected Sub garag(sender As Object, e As EventArgs)
        ...
        Response.Redirect("~/ScheduleDetails.aspx")
    End Sub
End Class