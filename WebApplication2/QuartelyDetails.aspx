<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QuartelyDetails.aspx.vb" Inherits="WebApplication2.QuartelyDetails" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0 px-3">Quartely Inspection Details</h6>
                </nav>
                  ...
                  <div class="card">
                    <div class="card-header pt-0 p-3 text-center">
                      <div class="">
                        ...
                        <asp:TextBox ID="txtwork" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Fleet No</label>
                                <asp:TextBox ID="txtfleet" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">REGNO </label>
                                 <asp:TextBox ID="txtmake" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                  ...
                  <div class="card">
                    <div class="card-header pt-0 p-3  text-center">
                      <div class="">
                        <div class="col-12">
                            ...
                            <asp:TextBox ID="txtloc" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                      </div>
                    </div>
                    <div class="card-body pt-0 p-3 text-center">
                        ...
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtmile" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <span class="input-group-date" id="basic-addon2">Date</span>
                            <asp:TextBox ID="txtdate" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                  </div>
      ...
      <div class="row mt-4">
            ...
            <div class="card-body pt-4 p-3">
               <div class="row">
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtEng" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                            <label class="form-label">Chasis Number</label>
                            <asp:TextBox ID="txtchasis" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="row">
                        <div class="col-6">
                           ...
                           <label for="validlic" class="ms-0">Is vehicle license valid</label>
                                <asp:DropDownList ID="validlic" runat="server" class="form-control">
                    ...
                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <span class="input-group-date" id="basic-addon2">Last Service Date</span>
                            <asp:TextBox ID="latdate" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                 <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                             <label class="form-label">Last Mileage</label>
                            <asp:TextBox ID="latmile" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <span class="input-group-date" id="basic-addon2">Next Service Date</span>
                            <asp:TextBox ID="nxtdate" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                 <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Dents</label>
                            <asp:TextBox ID="txtdents" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                             <label class="form-label">Defects</label>
                            <asp:TextBox ID="txtxdef" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                    </div>
                 <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Electricals</label>
                            <asp:TextBox ID="txtelec" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                             <label class="form-label">Suspension and Steering</label>
                            <asp:TextBox ID="txtsuspe" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                    </div>
                         <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Tyers</label>
                            <asp:TextBox ID="txttyew" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Windscreen and Rear View Mirrors</label>
                            <asp:TextBox ID="txtwind" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                    </div>
                 <div class="row">
                        <div class="col-6">
                           <div class="input-group input-group-static mb-4">
                           <label for="recact" class="ms-0">Recommendated Actions</label>
                                <asp:DropDownList ID="recact" runat="server" class="form-control">
                          
                    <asp:ListItem Text="No Action Necessary" Value="No"></asp:ListItem>
                    <asp:ListItem Text="To be Parked" Value="Park"></asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                                <label class="form-label">Reason for Vehicle Release</label>
                            <asp:TextBox ID="rsnrelese" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" ></asp:TextBox>
                            </div>
                        </div>
                    </div>
            </div>
              <div class="card-footer pt-0 p-3 text-center">
                        ...
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtne" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <span class="input-group-date" id="basic-addon2">Date</span>
                            <asp:TextBox ID="txttecdate" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                  </div>
        ...
        <div class="col-lg-4 col-12 mt-md-0 mt-4">
          <div class="card h-100 mb-4">
            ...
            <div class="card-body pt-4 p-3">
                     <asp:GridView ID="GridView3" runat="server" CssClass="table hover data-table-export nowrap" AutoGenerateColumns="false">
        <Columns>
            ...
            <ItemTemplate>
                <asp:CheckBox ID="chkRow1" runat="server" />
                   ...
                   <div class="card-footer pt-0 p-3 text-center">
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <label class="form-label">Technician</label>
                            <asp:TextBox ID="TextBox10" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <span class="input-group-date" id="basic-addon2">Date</span>
                            <asp:TextBox ID="TextBox11" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                        <div class="row">
                        <div class="col-6">
                            ...
                            <asp:TextBox ID="txtuser" runat="server" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-outline my-3">
                              <span class="input-group-date" id="basic-addon2">Date</span>
                            <asp:TextBox ID="txtuserdate" runat="server" class="form-control " onfocus="focused(this)" onfocusout="defocused(this)" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                  </div>
               ...
               <div class ="row mt-4">
                   ...
                   <div class="col-lg-4">
                       <div class ="col-12">
                           <asp:Button ID="Button1"  class="btn btn-lg btn-success w-100" runat="server" Text="Save" Onclick="Bulk_Insert"/>
                       </div>
                   </div>
                   <div class="col-lg-4"">
