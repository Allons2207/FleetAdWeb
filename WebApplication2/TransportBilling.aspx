<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SchoolAppMaster.Master" CodeBehind="TransportBilling.aspx.vb" Inherits="WebApplication2.TransportBilling" %>
                    ...
                    <table>
                        <tr>
                            <td>View Billing for: Stream</td><td>
                                <asp:TextBox ID="txtBillingVWYear" runat="server" Width="155px"></asp:TextBox>
                            </td>
                            <td>Month</td><td>
